...
const CORRECTION_TEXT: Record<GrammarErrorCategory, string> = {
  ...
  subject_verb_agreement:  'text-amber-300',
  modal_verb_pattern:      'text-amber-300',
  article_misuse:          'text-amber-300',
  demonstrative_agreement: 'text-amber-300',
  singular_plural:         'text-amber-300',
  uncountable_noun:        'text-amber-300',
  redundant_words:         'text-amber-300',
  verb_pattern:            'text-amber-300',
  verb_form:               'text-amber-300',
  verb_choice:             'text-amber-300',
  verb_missing:            'text-amber-300',
  verb_redundancy:         'text-amber-300',
  irregular_verb_form:     'text-amber-300',
  ...
  word_choice:             'text-amber-300',
  vague_reference:         'text-amber-300',
};
